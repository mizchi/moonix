...
const { environment, exit: exit$1, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } = imports['../../virtual_cli.ts'];
const { preopens, types } = imports['../../virtual_fs.ts'];
const { error, streams } = imports['../../virtual_io.ts'];
...
let gen = (function* _initGenerator () {
  ...
  function trampoline0(handle) {
    ...
    if (handleEntry.own) {
      throw new TypeError('unreachable trampoline for resource [ResourceIndex(5)]')
    }
  }
  ...
  ({ exports: exports2 } = yield instantiateCore(yield module1, {
    ...
    'wasi:filesystem/types@0.2.3': {
      ...
      '[method]descriptor.metadata-hash': exports0['18'],
